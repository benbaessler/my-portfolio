  ...
  return (
    <div id="work">
      <div className="expContainer">
        ...
        <p className="jobsum">
          A part-time, remote position for a web3 start-up building a social
          media platform for NFT artists to express themselves via their own
          created metaverses.
        </p>
        <ul>
          <li>
            <p>
              My responsibilies included working with a team of developers and
              designers to build a blockchain-based social media web app using
              React, TypeScript, Bootstrap and Ethers.
            </p>
          </li>
          <li>
            <p>
              Planning, writing, and testing the smart contract for an ERC-1155
              NFT collection on Polygon using Solidity, Chai, OpenZeppelin and
              Hardhat.
            </p>
          </li>
          <li>
